...
-- Module  Version: 5.8
--C:\lscc\diamond\3.12\ispfpga\bin\nt64\scuba.exe -w -n fifodc_w64x256_r64_outreg -lang vhdl -synth synplify -bus_exp 7 -bb -arch sa5p00 -type ebfifo -depth 256 -width 64 -rwidth 64 -regout -no_enable -reset_rel SYNC -pe -1 -pf -1 -rfill -fill -fdc C:/lattice/LimeSDR-Mini_GW/LimeSDR-Mini_lms7_trx/proj/ip/fifo_dc/fifodc_w64x256_r64_outreg/fifodc_w64x256_r64_outreg.fdc 

-- Wed Feb 23 21:57:58 2022
...
entity fifodc_w64x256_r64_outreg is
    port (
        ...
        Empty: out  std_logic; 
        Full: out  std_logic);
end fifodc_w64x256_r64_outreg;

architecture Structure of fifodc_w64x256_r64_outreg is
    ...
    attribute MEM_LPC_FILE of pdp_ram_0_0_1 : label is "fifodc_w64x256_r64_outreg.lpc";
    attribute MEM_INIT_FILE of pdp_ram_0_0_1 : label is "";
    attribute MEM_LPC_FILE of pdp_ram_0_1_0 : label is "fifodc_w64x256_r64_outreg.lpc";
...
begin
    ...
    pdp_ram_0_1_0: PDPW16KD
        ...
        port map (DI35=>scuba_vlo, DI34=>scuba_vlo, DI33=>scuba_vlo, 
            ...
            DI29=>scuba_vlo, DI28=>scuba_vlo, DI27=>Data(63), 
            ...
            DO18=>Q(36), DO17=>open, DO16=>open, DO15=>open, DO14=>open, 
            DO13=>open, DO12=>open, DO11=>open, DO10=>open, DO9=>Q(63), 
            DO8=>Q(62), DO7=>Q(61), DO6=>Q(60), DO5=>Q(59), DO4=>Q(58), 
            DO3=>Q(57), DO2=>Q(56), DO1=>Q(55), DO0=>Q(54));
