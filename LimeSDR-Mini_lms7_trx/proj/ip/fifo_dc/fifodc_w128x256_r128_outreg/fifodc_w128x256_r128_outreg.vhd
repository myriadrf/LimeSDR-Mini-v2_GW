...
-- Module  Version: 5.8
--C:\lscc\diamond\3.12\ispfpga\bin\nt64\scuba.exe -w -n fifodc_w128x256_r128_outreg -lang vhdl -synth synplify -bus_exp 7 -bb -arch sa5p00 -type ebfifo -depth 256 -width 128 -rwidth 128 -regout -no_enable -reset_rel SYNC -pe -1 -pf -1 -rfill -fill -fdc C:/lattice/LimeSDR-Mini_GW/LimeSDR-Mini_lms7_trx/proj/ip/fifo_dc/fifodc_w128x256_r128_outreg/fifodc_w128x256_r128_outreg.fdc 
...
entity fifodc_w128x256_r128_outreg is
    port (
        ...
        Empty: out  std_logic; 
        Full: out  std_logic);
end fifodc_w128x256_r128_outreg;

architecture Structure of fifodc_w128x256_r128_outreg is
    ...
    attribute MEM_LPC_FILE of pdp_ram_0_0_3 : label is "fifodc_w128x256_r128_outreg.lpc";
    attribute MEM_INIT_FILE of pdp_ram_0_0_3 : label is "";
    attribute MEM_LPC_FILE of pdp_ram_0_1_2 : label is "fifodc_w128x256_r128_outreg.lpc";
    attribute MEM_INIT_FILE of pdp_ram_0_1_2 : label is "";
    attribute MEM_LPC_FILE of pdp_ram_0_2_1 : label is "fifodc_w128x256_r128_outreg.lpc";
    attribute MEM_INIT_FILE of pdp_ram_0_2_1 : label is "";
    attribute MEM_LPC_FILE of pdp_ram_0_3_0 : label is "fifodc_w128x256_r128_outreg.lpc";
...
begin
    ...
    XOR2_t1: XOR2
        port map (A=>wptr_8, B=>r_gcount_w28, Z=>wfill_sub_msb);

    XOR2_t0: XOR2
        port map (A=>w_gcount_r28, B=>rptr_8, Z=>rfill_sub_msb);
    ...
    pdp_ram_0_1_2: PDPW16KD
        ...
        RESETMODE=> "ASYNC", REGMODE=> "OUTREG", DATA_WIDTH_R=>  36, 
        DATA_WIDTH_W=>  36)
        port map (DI35=>Data(71), DI34=>Data(70), DI33=>Data(69), 
            DI32=>Data(68), DI31=>Data(67), DI30=>Data(66), 
            DI29=>Data(65), DI28=>Data(64), DI27=>Data(63), 
            DI26=>Data(62), DI25=>Data(61), DI24=>Data(60), 
            DI23=>Data(59), DI22=>Data(58), DI21=>Data(57), 
            DI20=>Data(56), DI19=>Data(55), DI18=>Data(54), 
            ...
            ADR1=>scuba_vlo, ADR0=>scuba_vlo, CER=>scuba_vhi, 
            OCER=>scuba_vhi, CLKR=>RdClock, CSR2=>scuba_vlo, 
            CSR1=>scuba_vlo, CSR0=>rden_i, RST=>Reset, DO35=>Q(53), 
            DO34=>Q(52), DO33=>Q(51), DO32=>Q(50), DO31=>Q(49), 
            DO30=>Q(48), DO29=>Q(47), DO28=>Q(46), DO27=>Q(45), 
            DO26=>Q(44), DO25=>Q(43), DO24=>Q(42), DO23=>Q(41), 
            DO22=>Q(40), DO21=>Q(39), DO20=>Q(38), DO19=>Q(37), 
            DO18=>Q(36), DO17=>Q(71), DO16=>Q(70), DO15=>Q(69), 
            DO14=>Q(68), DO13=>Q(67), DO12=>Q(66), DO11=>Q(65), 
            DO10=>Q(64), DO9=>Q(63), DO8=>Q(62), DO7=>Q(61), DO6=>Q(60), 
    ...
    pdp_ram_0_2_1: PDPW16KD
        ...
        RESETMODE=> "ASYNC", REGMODE=> "OUTREG", DATA_WIDTH_R=>  36, 
        DATA_WIDTH_W=>  36)
        port map (DI35=>Data(107), DI34=>Data(106), DI33=>Data(105), 
            DI32=>Data(104), DI31=>Data(103), DI30=>Data(102), 
            DI29=>Data(101), DI28=>Data(100), DI27=>Data(99), 
            DI26=>Data(98), DI25=>Data(97), DI24=>Data(96), 
            DI23=>Data(95), DI22=>Data(94), DI21=>Data(93), 
            DI20=>Data(92), DI19=>Data(91), DI18=>Data(90), 
            DI17=>Data(89), DI16=>Data(88), DI15=>Data(87), 
            ...
            ADR1=>scuba_vlo, ADR0=>scuba_vlo, CER=>scuba_vhi, 
            OCER=>scuba_vhi, CLKR=>RdClock, CSR2=>scuba_vlo, 
            CSR1=>scuba_vlo, CSR0=>rden_i, RST=>Reset, DO35=>Q(89), 
            DO34=>Q(88), DO33=>Q(87), DO32=>Q(86), DO31=>Q(85), 
            DO30=>Q(84), DO29=>Q(83), DO28=>Q(82), DO27=>Q(81), 
            DO26=>Q(80), DO25=>Q(79), DO24=>Q(78), DO23=>Q(77), 
            DO22=>Q(76), DO21=>Q(75), DO20=>Q(74), DO19=>Q(73), 
            DO18=>Q(72), DO17=>Q(107), DO16=>Q(106), DO15=>Q(105), 
            DO14=>Q(104), DO13=>Q(103), DO12=>Q(102), DO11=>Q(101), 
            DO10=>Q(100), DO9=>Q(99), DO8=>Q(98), DO7=>Q(97), DO6=>Q(96), 
            DO5=>Q(95), DO4=>Q(94), DO3=>Q(93), DO2=>Q(92), DO1=>Q(91), 
            DO0=>Q(90));
    ...
    pdp_ram_0_3_0: PDPW16KD
        ...
        port map (DI35=>scuba_vlo, DI34=>scuba_vlo, DI33=>scuba_vlo, 
            ...
            DI20=>scuba_vlo, DI19=>Data(127), DI18=>Data(126), 
            DI17=>Data(125), DI16=>Data(124), DI15=>Data(123), 
            DI14=>Data(122), DI13=>Data(121), DI12=>Data(120), 
            ...
            ADR1=>scuba_vlo, ADR0=>scuba_vlo, CER=>scuba_vhi, 
            OCER=>scuba_vhi, CLKR=>RdClock, CSR2=>scuba_vlo, 
            CSR1=>scuba_vlo, CSR0=>rden_i, RST=>Reset, DO35=>Q(125), 
            DO34=>Q(124), DO33=>Q(123), DO32=>Q(122), DO31=>Q(121), 
            DO30=>Q(120), DO29=>Q(119), DO28=>Q(118), DO27=>Q(117), 
            DO26=>Q(116), DO25=>Q(115), DO24=>Q(114), DO23=>Q(113), 
            DO22=>Q(112), DO21=>Q(111), DO20=>Q(110), DO19=>Q(109), 
            DO18=>Q(108), DO17=>open, DO16=>open, DO15=>open, DO14=>open, 
            DO13=>open, DO12=>open, DO11=>open, DO10=>open, DO9=>open, 
            DO8=>open, DO7=>open, DO6=>open, DO5=>open, DO4=>open, 
            DO3=>open, DO2=>open, DO1=>Q(127), DO0=>Q(126));
    ...
    wfill_4: CCU2C
        generic map (INJECT1_1=> "NO", INJECT1_0=> "NO", INIT1=> X"99AA", 
        INIT0=> X"99AA")
        port map (A0=>wptr_7, A1=>wfill_sub_msb, B0=>rcount_w7, 
            B1=>scuba_vlo, C0=>scuba_vhi, C1=>scuba_vhi, D0=>scuba_vhi, 
    ...
    rfill_3: CCU2C
        generic map (INJECT1_1=> "NO", INJECT1_0=> "NO", INIT1=> X"99AA", 
        INIT0=> X"99AA")
        port map (A0=>w_g2b_xor_cluster_0, A1=>wcount_r6, B0=>rptr_5, 
    ...
    rfill_4: CCU2C
        generic map (INJECT1_1=> "NO", INJECT1_0=> "NO", INIT1=> X"99AA", 
        INIT0=> X"99AA")
        port map (A0=>wcount_r7, A1=>rfill_sub_msb, B0=>rptr_7, 
            B1=>scuba_vlo, C0=>scuba_vhi, C1=>scuba_vhi, D0=>scuba_vhi, 
