...
entity fifo_dc_64x256x64_outreg is
    port (
        ...
        Empty: out  std_logic; 
        Full: out  std_logic);
end fifo_dc_64x256x64_outreg;

architecture Structure of fifo_dc_64x256x64_outreg is
    ...
    attribute MEM_LPC_FILE of pdp_ram_0_0_1 : label is "fifo_dc_64x256x64_outreg.lpc";
    attribute MEM_INIT_FILE of pdp_ram_0_0_1 : label is "";
    attribute MEM_LPC_FILE of pdp_ram_0_1_0 : label is "fifo_dc_64x256x64_outreg.lpc";
