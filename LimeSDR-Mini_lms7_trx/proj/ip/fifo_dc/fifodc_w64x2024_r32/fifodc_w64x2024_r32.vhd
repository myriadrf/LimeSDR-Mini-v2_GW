...
-- Module  Version: 5.8
--C:\lscc\diamond\3.12\ispfpga\bin\nt64\scuba.exe -w -n fifodc_w64x2024_r32 -lang vhdl -synth synplify -bus_exp 7 -bb -arch sa5p00 -type ebfifo -depth 2048 -width 64 -rwidth 32 -reset_rel SYNC -pe -1 -pf -1 -rfill -fill -fdc D:/darbas/lattice/LimeSDR-Mini_GW/LimeSDR-Mini_lms7_trx/ip/fifo_dc/fifodc_w64x2024_r32/fifodc_w64x2024_r32.fdc 

-- Thu Feb 17 23:06:40 2022
...
entity fifodc_w64x2024_r32 is
    port (
        ...
        RCNT: out  std_logic_vector(12 downto 0); 
        Empty: out  std_logic; 
        Full: out  std_logic);
end fifodc_w64x2024_r32;

architecture Structure of fifodc_w64x2024_r32 is
    ...
    attribute MEM_LPC_FILE of pdp_ram_0_0_7 : label is "fifodc_w64x2024_r32.lpc";
    attribute MEM_INIT_FILE of pdp_ram_0_0_7 : label is "";
    attribute MEM_LPC_FILE of pdp_ram_0_1_6 : label is "fifodc_w64x2024_r32.lpc";
    attribute MEM_INIT_FILE of pdp_ram_0_1_6 : label is "";
    attribute MEM_LPC_FILE of pdp_ram_0_2_5 : label is "fifodc_w64x2024_r32.lpc";
    attribute MEM_INIT_FILE of pdp_ram_0_2_5 : label is "";
    attribute MEM_LPC_FILE of pdp_ram_0_3_4 : label is "fifodc_w64x2024_r32.lpc";
    attribute MEM_INIT_FILE of pdp_ram_0_3_4 : label is "";
    attribute MEM_LPC_FILE of pdp_ram_0_4_3 : label is "fifodc_w64x2024_r32.lpc";
    attribute MEM_INIT_FILE of pdp_ram_0_4_3 : label is "";
    attribute MEM_LPC_FILE of pdp_ram_0_5_2 : label is "fifodc_w64x2024_r32.lpc";
    attribute MEM_INIT_FILE of pdp_ram_0_5_2 : label is "";
    attribute MEM_LPC_FILE of pdp_ram_0_6_1 : label is "fifodc_w64x2024_r32.lpc";
    attribute MEM_INIT_FILE of pdp_ram_0_6_1 : label is "";
    attribute MEM_LPC_FILE of pdp_ram_0_7_0 : label is "fifodc_w64x2024_r32.lpc";
...
begin
    ...
    XOR2_t0: XOR2
        port map (A=>w_gcount_r211, B=>rptr_12, Z=>rfill_sub_msb);
    ...
    pdp_ram_0_0_7: DP16KD
        ...
        port map (DIA17=>scuba_vlo, DIA16=>scuba_vlo, DIA15=>scuba_vlo, 
            ...
            DIA8=>scuba_vlo, DIA7=>Data(35), DIA6=>Data(34), 
            DIA5=>Data(33), DIA4=>Data(32), DIA3=>Data(3), DIA2=>Data(2), 
            DIA1=>Data(1), DIA0=>Data(0), ADA13=>wptr_10, ADA12=>wptr_9, 
            ...
            DIB1=>scuba_vlo, DIB0=>scuba_vlo, ADB13=>rptr_11, 
            ADB12=>rptr_10, ADB11=>rptr_9, ADB10=>rptr_8, ADB9=>rptr_7, 
            ADB8=>rptr_6, ADB7=>rptr_5, ADB6=>rptr_4, ADB5=>rptr_3, 
            ADB4=>rptr_2, ADB3=>rptr_1, ADB2=>rptr_0, ADB1=>scuba_vlo, 
    ...
    pdp_ram_0_1_6: DP16KD
        ...
        port map (DIA17=>scuba_vlo, DIA16=>scuba_vlo, DIA15=>scuba_vlo, 
            DIA14=>scuba_vlo, DIA13=>scuba_vlo, DIA12=>scuba_vlo, 
            DIA11=>scuba_vlo, DIA10=>scuba_vlo, DIA9=>scuba_vlo, 
            DIA8=>scuba_vlo, DIA7=>Data(39), DIA6=>Data(38), 
            DIA5=>Data(37), DIA4=>Data(36), DIA3=>Data(7), DIA2=>Data(6), 
            DIA1=>Data(5), DIA0=>Data(4), ADA13=>wptr_10, ADA12=>wptr_9, 
            ADA11=>wptr_8, ADA10=>wptr_7, ADA9=>wptr_6, ADA8=>wptr_5, 
            ADA7=>wptr_4, ADA6=>wptr_3, ADA5=>wptr_2, ADA4=>wptr_1, 
            ADA3=>wptr_0, ADA2=>scuba_vlo, ADA1=>scuba_vlo, 
            ADA0=>scuba_vlo, CEA=>wren_i, OCEA=>wren_i, CLKA=>WrClock, 
    ...
    pdp_ram_0_2_5: DP16KD
        ...
        port map (DIA17=>scuba_vlo, DIA16=>scuba_vlo, DIA15=>scuba_vlo, 
            DIA14=>scuba_vlo, DIA13=>scuba_vlo, DIA12=>scuba_vlo, 
            DIA11=>scuba_vlo, DIA10=>scuba_vlo, DIA9=>scuba_vlo, 
            DIA8=>scuba_vlo, DIA7=>Data(43), DIA6=>Data(42), 
            DIA5=>Data(41), DIA4=>Data(40), DIA3=>Data(11), 
            DIA2=>Data(10), DIA1=>Data(9), DIA0=>Data(8), ADA13=>wptr_10, 
            ADA12=>wptr_9, ADA11=>wptr_8, ADA10=>wptr_7, ADA9=>wptr_6, 
            ...
            DOB15=>open, DOB14=>open, DOB13=>open, DOB12=>open, 
            DOB11=>open, DOB10=>open, DOB9=>open, DOB8=>open, DOB7=>open, 
            DOB6=>open, DOB5=>open, DOB4=>open, DOB3=>Q(11), DOB2=>Q(10), 
            DOB1=>Q(9), DOB0=>Q(8));
    ...
    pdp_ram_0_3_4: DP16KD
        ...
        port map (DIA17=>scuba_vlo, DIA16=>scuba_vlo, DIA15=>scuba_vlo, 
            DIA14=>scuba_vlo, DIA13=>scuba_vlo, DIA12=>scuba_vlo, 
            DIA11=>scuba_vlo, DIA10=>scuba_vlo, DIA9=>scuba_vlo, 
            DIA8=>scuba_vlo, DIA7=>Data(47), DIA6=>Data(46), 
            DIA5=>Data(45), DIA4=>Data(44), DIA3=>Data(15), 
            ...
            ADB13=>rptr_11, ADB12=>rptr_10, ADB11=>rptr_9, ADB10=>rptr_8, 
            ADB9=>rptr_7, ADB8=>rptr_6, ADB7=>rptr_5, ADB6=>rptr_4, 
            ADB5=>rptr_3, ADB4=>rptr_2, ADB3=>rptr_1, ADB2=>rptr_0, 
    ...
    pdp_ram_0_4_3: DP16KD
        ...
        port map (DIA17=>scuba_vlo, DIA16=>scuba_vlo, DIA15=>scuba_vlo, 
            DIA14=>scuba_vlo, DIA13=>scuba_vlo, DIA12=>scuba_vlo, 
            DIA11=>scuba_vlo, DIA10=>scuba_vlo, DIA9=>scuba_vlo, 
            DIA8=>scuba_vlo, DIA7=>Data(51), DIA6=>Data(50), 
            DIA5=>Data(49), DIA4=>Data(48), DIA3=>Data(19), 
            DIA2=>Data(18), DIA1=>Data(17), DIA0=>Data(16), 
            ADA13=>wptr_10, ADA12=>wptr_9, ADA11=>wptr_8, ADA10=>wptr_7, 
            ADA9=>wptr_6, ADA8=>wptr_5, ADA7=>wptr_4, ADA6=>wptr_3, 
            ADA5=>wptr_2, ADA4=>wptr_1, ADA3=>wptr_0, ADA2=>scuba_vlo, 
            ADA1=>scuba_vlo, ADA0=>scuba_vlo, CEA=>wren_i, OCEA=>wren_i, 
    ...
    pdp_ram_0_5_2: DP16KD
        ...
        port map (DIA17=>scuba_vlo, DIA16=>scuba_vlo, DIA15=>scuba_vlo, 
            DIA14=>scuba_vlo, DIA13=>scuba_vlo, DIA12=>scuba_vlo, 
            DIA11=>scuba_vlo, DIA10=>scuba_vlo, DIA9=>scuba_vlo, 
            DIA8=>scuba_vlo, DIA7=>Data(55), DIA6=>Data(54), 
            DIA5=>Data(53), DIA4=>Data(52), DIA3=>Data(23), 
            DIA2=>Data(22), DIA1=>Data(21), DIA0=>Data(20), 
            ADA13=>wptr_10, ADA12=>wptr_9, ADA11=>wptr_8, ADA10=>wptr_7, 
            ADA9=>wptr_6, ADA8=>wptr_5, ADA7=>wptr_4, ADA6=>wptr_3, 
            ADA5=>wptr_2, ADA4=>wptr_1, ADA3=>wptr_0, ADA2=>scuba_vlo, 
            ADA1=>scuba_vlo, ADA0=>scuba_vlo, CEA=>wren_i, OCEA=>wren_i, 
    ...
    pdp_ram_0_6_1: DP16KD
        ...
        port map (DIA17=>scuba_vlo, DIA16=>scuba_vlo, DIA15=>scuba_vlo, 
            DIA14=>scuba_vlo, DIA13=>scuba_vlo, DIA12=>scuba_vlo, 
            DIA11=>scuba_vlo, DIA10=>scuba_vlo, DIA9=>scuba_vlo, 
            DIA8=>scuba_vlo, DIA7=>Data(59), DIA6=>Data(58), 
            DIA5=>Data(57), DIA4=>Data(56), DIA3=>Data(27), 
            DIA2=>Data(26), DIA1=>Data(25), DIA0=>Data(24), 
            ADA13=>wptr_10, ADA12=>wptr_9, ADA11=>wptr_8, ADA10=>wptr_7, 
            ADA9=>wptr_6, ADA8=>wptr_5, ADA7=>wptr_4, ADA6=>wptr_3, 
            ADA5=>wptr_2, ADA4=>wptr_1, ADA3=>wptr_0, ADA2=>scuba_vlo, 
            ADA1=>scuba_vlo, ADA0=>scuba_vlo, CEA=>wren_i, OCEA=>wren_i, 
    ...
    pdp_ram_0_7_0: DP16KD
        ...
        port map (DIA17=>scuba_vlo, DIA16=>scuba_vlo, DIA15=>scuba_vlo, 
            DIA14=>scuba_vlo, DIA13=>scuba_vlo, DIA12=>scuba_vlo, 
            DIA11=>scuba_vlo, DIA10=>scuba_vlo, DIA9=>scuba_vlo, 
            DIA8=>scuba_vlo, DIA7=>Data(63), DIA6=>Data(62), 
            DIA5=>Data(61), DIA4=>Data(60), DIA3=>Data(31), 
            DIA2=>Data(30), DIA1=>Data(29), DIA0=>Data(28), 
            ADA13=>wptr_10, ADA12=>wptr_9, ADA11=>wptr_8, ADA10=>wptr_7, 
            ADA9=>wptr_6, ADA8=>wptr_5, ADA7=>wptr_4, ADA6=>wptr_3, 
            ADA5=>wptr_2, ADA4=>wptr_1, ADA3=>wptr_0, ADA2=>scuba_vlo, 
            ADA1=>scuba_vlo, ADA0=>scuba_vlo, CEA=>wren_i, OCEA=>wren_i, 
    ...
    r_gctr_6: CCU2C
        ...
        port map (A0=>rcount_12, A1=>scuba_vlo, B0=>scuba_vlo, 
            B1=>scuba_vlo, C0=>scuba_vhi, C1=>scuba_vhi, D0=>scuba_vhi, 
            D1=>scuba_vhi, CIN=>co5_1, S0=>ircount_12, S1=>open, 
            COUT=>co6);

    precin_inst375: CCU2C
    ...
    rfill_5: CCU2C
        generic map (INJECT1_1=> "NO", INJECT1_0=> "NO", INIT1=> X"99AA", 
        INIT0=> X"99AA")
        port map (A0=>w_g2b_xor_cluster_0, A1=>wcount_r9, B0=>rptr_9, 
            B1=>rptr_10, C0=>scuba_vhi, C1=>scuba_vhi, D0=>scuba_vhi, 
    ...
    rfill_6: CCU2C
        generic map (INJECT1_1=> "NO", INJECT1_0=> "NO", INIT1=> X"99AA", 
        INIT0=> X"99AA")
        port map (A0=>wcount_r10, A1=>rfill_sub_msb, B0=>rptr_11, 
            B1=>scuba_vlo, C0=>scuba_vhi, C1=>scuba_vhi, D0=>scuba_vhi, 
            D1=>scuba_vhi, CIN=>co5_3, S0=>rfill_sub_11, 
            S1=>rfill_sub_12, COUT=>co6_1);
    ...
    rfilld: CCU2C
        ...
        port map (A0=>scuba_vlo, A1=>scuba_vlo, B0=>scuba_vlo, 
            B1=>scuba_vlo, C0=>scuba_vhi, C1=>scuba_vhi, D0=>scuba_vhi, 
            D1=>scuba_vhi, CIN=>co6_1, S0=>co6_1d, S1=>open, COUT=>open);
    ...
    empty_cmp_6: CCU2C
        ...
        port map (A0=>empty_cmp_set, A1=>scuba_vlo, B0=>empty_cmp_clr, 
            B1=>scuba_vlo, C0=>scuba_vhi, C1=>scuba_vhi, D0=>scuba_vhi, 
            D1=>scuba_vhi, CIN=>co5_4, S0=>open, S1=>open, 
            COUT=>empty_d_c);
