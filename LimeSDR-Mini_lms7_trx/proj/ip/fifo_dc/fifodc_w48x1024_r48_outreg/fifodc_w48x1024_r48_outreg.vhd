...
-- Module  Version: 5.8
--C:\lscc\diamond\3.12\ispfpga\bin\nt64\scuba.exe -w -n fifodc_w48x1024_r48_outreg -lang vhdl -synth synplify -bus_exp 7 -bb -arch sa5p00 -type ebfifo -depth 1024 -width 48 -rwidth 48 -regout -no_enable -reset_rel SYNC -pe -1 -pf -1 -rfill -fill -fdc C:/lattice/LimeSDR-Mini_GW/LimeSDR-Mini_lms7_trx/proj/ip/fifo_dc/fifodc_w48x1024_r48_outreg/fifodc_w48x1024_r48_outreg.fdc 

-- Wed Feb 23 21:55:32 2022
...
entity fifodc_w48x1024_r48_outreg is
    port (
        ...
        Empty: out  std_logic; 
        Full: out  std_logic);
end fifodc_w48x1024_r48_outreg;

architecture Structure of fifodc_w48x1024_r48_outreg is
    ...
    attribute MEM_LPC_FILE of pdp_ram_0_0_2 : label is "fifodc_w48x1024_r48_outreg.lpc";
    attribute MEM_INIT_FILE of pdp_ram_0_0_2 : label is "";
    attribute MEM_LPC_FILE of pdp_ram_0_1_1 : label is "fifodc_w48x1024_r48_outreg.lpc";
    attribute MEM_INIT_FILE of pdp_ram_0_1_1 : label is "";
    attribute MEM_LPC_FILE of pdp_ram_0_2_0 : label is "fifodc_w48x1024_r48_outreg.lpc";
...
begin
    ...
    pdp_ram_0_0_2: DP16KD
        ...
        port map (DIA17=>Data(17), DIA16=>Data(16), DIA15=>Data(15), 
            ...
            CEB=>rden_i, OCEB=>scuba_vhi, CLKB=>RdClock, WEB=>scuba_vlo, 
    ...
    pdp_ram_0_2_0: DP16KD
        ...
        port map (DIA17=>scuba_vlo, DIA16=>scuba_vlo, DIA15=>scuba_vlo, 
            ...
            DOB14=>open, DOB13=>open, DOB12=>open, DOB11=>Q(47), 
            DOB10=>Q(46), DOB9=>Q(45), DOB8=>Q(44), DOB7=>Q(43), 
            DOB6=>Q(42), DOB5=>Q(41), DOB4=>Q(40), DOB3=>Q(39), 
