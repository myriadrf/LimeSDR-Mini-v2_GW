...
-- Module  Version: 5.8
--C:\lscc\diamond\3.12\ispfpga\bin\nt64\scuba.exe -w -n fifo_dc_32x256x32 -lang vhdl -synth lse -bus_exp 7 -bb -arch sa5p00 -type ebfifo -depth 256 -width 32 -rwidth 32 -reset_rel SYNC -pe -1 -pf -1 -rfill -fill -fdc D:/darbas/lattice/LimeSDR-Mini_GW/LimeSDR-Mini_lms7_trx/ip/fifo_dc/fifo_dc_32x256x32/fifo_dc_32x256x32.fdc 
...
entity fifo_dc_32x256x32 is
    port (
        ...
        Empty: out  std_logic; 
        Full: out  std_logic);
end fifo_dc_32x256x32;

architecture Structure of fifo_dc_32x256x32 is
    ...
    attribute MEM_LPC_FILE of pdp_ram_0_0_0 : label is "fifo_dc_32x256x32.lpc";
