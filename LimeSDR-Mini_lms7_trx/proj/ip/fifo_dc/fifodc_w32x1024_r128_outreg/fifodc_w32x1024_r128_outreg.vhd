...
-- Module  Version: 5.8
--C:\lscc\diamond\3.12\ispfpga\bin\nt64\scuba.exe -w -n fifodc_w32x1024_r128_outreg -lang vhdl -synth synplify -bus_exp 7 -bb -arch sa5p00 -type ebfifo -depth 1024 -width 32 -rwidth 128 -regout -no_enable -reset_rel SYNC -pe -1 -pf -1 -rfill -fill -fdc D:/darbas/lattice/LimeSDR-Mini_GW/LimeSDR-Mini_lms7_trx/ip/fifo_dc/fifodc_w32x1024_r128_outreg/fifodc_w32x1024_r128_outreg.fdc 

-- Thu Feb 17 23:08:35 2022
...
entity fifodc_w32x1024_r128_outreg is
    port (
        ...
        Empty: out  std_logic; 
        Full: out  std_logic);
end fifodc_w32x1024_r128_outreg;

architecture Structure of fifodc_w32x1024_r128_outreg is
    ...
    attribute MEM_LPC_FILE of pdp_ram_0_0_3 : label is "fifodc_w32x1024_r128_outreg.lpc";
    attribute MEM_INIT_FILE of pdp_ram_0_0_3 : label is "";
    attribute MEM_LPC_FILE of pdp_ram_0_1_2 : label is "fifodc_w32x1024_r128_outreg.lpc";
    attribute MEM_INIT_FILE of pdp_ram_0_1_2 : label is "";
    attribute MEM_LPC_FILE of pdp_ram_0_2_1 : label is "fifodc_w32x1024_r128_outreg.lpc";
    attribute MEM_INIT_FILE of pdp_ram_0_2_1 : label is "";
    attribute MEM_LPC_FILE of pdp_ram_0_3_0 : label is "fifodc_w32x1024_r128_outreg.lpc";
...
begin
    ...
    pdp_ram_0_0_3: DP16KD
        ...
        port map (DIA17=>scuba_vlo, DIA16=>scuba_vlo, DIA15=>scuba_vlo, 
            ...
            RSTB=>Reset, DOA17=>Q(40), DOA16=>Q(39), DOA15=>Q(38), 
            DOA14=>Q(37), DOA13=>Q(36), DOA12=>Q(35), DOA11=>Q(34), 
            DOA10=>Q(33), DOA9=>Q(32), DOA8=>Q(8), DOA7=>Q(7), 
            DOA6=>Q(6), DOA5=>Q(5), DOA4=>Q(4), DOA3=>Q(3), DOA2=>Q(2), 
            DOA1=>Q(1), DOA0=>Q(0), DOB17=>Q(104), DOB16=>Q(103), 
            DOB15=>Q(102), DOB14=>Q(101), DOB13=>Q(100), DOB12=>Q(99), 
            DOB11=>Q(98), DOB10=>Q(97), DOB9=>Q(96), DOB8=>Q(72), 
            DOB7=>Q(71), DOB6=>Q(70), DOB5=>Q(69), DOB4=>Q(68), 
            DOB3=>Q(67), DOB2=>Q(66), DOB1=>Q(65), DOB0=>Q(64));
