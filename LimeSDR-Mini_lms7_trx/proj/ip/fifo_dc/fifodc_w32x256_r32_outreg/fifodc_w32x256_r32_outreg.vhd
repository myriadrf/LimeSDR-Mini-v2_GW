...
-- Module  Version: 5.8
--C:\lscc\diamond\3.12\ispfpga\bin\nt64\scuba.exe -w -n fifodc_w32x256_r32_outreg -lang vhdl -synth synplify -bus_exp 7 -bb -arch sa5p00 -type ebfifo -depth 256 -width 32 -rwidth 32 -regout -no_enable -reset_rel SYNC -pe -1 -pf -1 -rfill -fill -fdc D:/darbas/lattice/LimeSDR-Mini_GW/LimeSDR-Mini_lms7_trx/ip/fifo_dc/fifodc_w32x256_r32_outreg/fifodc_w32x256_r32_outreg.fdc 

-- Thu Feb 17 23:00:56 2022
...
entity fifodc_w32x256_r32_outreg is
    port (
        ...
        Empty: out  std_logic; 
        Full: out  std_logic);
end fifodc_w32x256_r32_outreg;

architecture Structure of fifodc_w32x256_r32_outreg is
    ...
    attribute MEM_LPC_FILE of pdp_ram_0_0_0 : label is "fifodc_w32x256_r32_outreg.lpc";
...
begin
    ...
    pdp_ram_0_0_0: PDPW16KD
        ...
        port map (DI35=>scuba_vlo, DI34=>scuba_vlo, DI33=>scuba_vlo, 
            ...
            DO16=>open, DO15=>open, DO14=>open, DO13=>Q(31), DO12=>Q(30), 
