...
signal pll_logic_reset     : std_logic;
...
begin
   ...
   pll_logic_reset <= not pll_logic_reset_n;
   ...
   -- rxtx_pll_inst0 : entity work. pll
   -- port map (
      -- CLKI  =>pll_inclk,
      -- RST   =>pll_logic_reset,       
      -- CLKOP =>pll_c0, 
   ...
   pll_c2             <= pll_inclk;  
   pll_c3             <= pll_inclk;
	pll_locked 			 <= pll_logic_reset_n;
      
      
      --TODO: remove pll config bypass logic
      to_pllcfg.pllcfg_busy    <= '0';
      to_pllcfg.pllcfg_done    <= '1';
      to_pllcfg.phcfg_done     <= '1';
      to_pllcfg.phcfg_error    <= '0';
      to_pllcfg.pll_lock       <= (others=>'0');
end arch;   
