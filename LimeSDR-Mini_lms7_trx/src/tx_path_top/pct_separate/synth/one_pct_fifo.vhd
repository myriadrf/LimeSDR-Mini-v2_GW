...
-- ----------------------------------------------------------------------------   
   ...
   inst1_fifo_inst : entity work.fifodc_w128x256_r128
   port map (
      Data        => inst0_pct_data,
      WrClock     => clk, 
      RdClock     => pct_rdclk, 
      WrEn        => inst0_pct_wrreq, 
      RdEn        => pct_data_rdreq, 
      Reset       => inst1_reset, 
      RPReset     => inst1_reset, 
      Q           => pct_data, 
   ...
   inst1_wrempty <= inst1_empty;
   inst1_rdempty <= inst1_empty;
